...
import OpenViduLayout from '../components/layout/openvidu-layout';
...
class VideoRoomComponent extends Component {
    constructor(props) {
        ...
        this.OPENVIDU_SERVER_URL = this.props.openviduServerUrl
            ...
            : 'https://13.125.106.69';
        this.OPENVIDU_SERVER_SECRET = this.props.openviduSecret ? this.props.openviduSecret : 'techterview'; this.hasBeenUpdated = false;
        this.layout = new OpenViduLayout();
        let sessionName = this.props.sessionName ? this.props.sessionName : 'SessionA'; //세션이 고정되어 있는 이유인거 같음
        ...
        this.state = {
            ...
            localUser: undefined,
            subscribers: [],
            chatDisplay: 'none', // 시작할때 채팅창이 보여지고 시작하느냐, 마느냐
